...
def download_all_files(disease_terms=[], other_keys=[], directory_name="to_upload", default_filename="SearchResults.csv", upload_to_drive=False):
  if upload_to_drive:
  ...
  for term in disease_terms:
    autofill_clinicaltrials(browser, download_path, disease_terms=term)
    new_file_name = update_file_name(disease_terms=term)
  ...
  for key in other_keys:
    autofill_clinicaltrials(browser, download_path, other_keys=key)
    new_file_name = update_file_name(other_keys=key)
...
def download_file(disease_terms="", other_keys="", country="", directory_name="to_upload", default_filename="SearchResults.csv", upload_to_drive=False):
  if upload_to_drive:
    creds = google_get_creds()
  ...
  autofill_clinicaltrials(browser, download_path, disease_terms, other_keys, country)

  # update the name
  new_file_name = update_file_name(disease_terms, other_keys, country)
...
def update_file_name(disease_terms="", other_keys="", country=""):
  new_file_name = f"{disease_terms}_{other_keys}_{country}"
...
def autofill_clinicaltrials(browser, download_path, disease_terms="", other_keys="", country="", default_filename="SearchResults.csv"):
  ...
  condition_or_disease.send_keys(disease_terms)
