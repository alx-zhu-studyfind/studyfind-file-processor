...
<p>I hope this email finds you well. My name is Andy. I&rsquo;m a part of the StudyFind Outreach team.</p>

<p>StudyFind is a startup attempting to build a registry that aims to diversify clinical trials and research studies! Our research has led us to believe that you are the best person to reach out to regarding our Surveys.</p>

<p>Our team has been working tirelessly to compose a survey that recognizes the trials and tribulations that impact various communities. The survey also contains a section where individuals can volunteer to participate in the StudyFind registry, which would only require their contact information.</p>

<p>If you or anyone in your network would benefit from a diversified participant base or would benefit from being on a diverse research registry, we&rsquo;d appreciate your participation or willingness to share this with your contacts. Just let us know, and we can forward you the link to our survey.</p>

<p>Additionally, if you&rsquo;re recruiting for clinical research or research studies, we&rsquo;d love to share your study with our registry.</p>
...
EMAIL_DICT = {
    "anika.shah03@studyfind.org": {
      "app_password": "vdfbtcpvtklsujjn",
      "subject_lines": SUBJECT_LINES,
      "body": LINK_EMAIL_BODY
    },
    "Andy.G@studyfind.org": {
      "app_password": "jfrkeggxnulariqp",
      "subject_lines": SUBJECT_LINES,
      "body": NOLINK_EMAIL_BODY
    }
